...
if ($('#simpleBarChart2').length != 0) {
       ...
       var dataSimpleBarChart = {
            ...
            var simpleBarChart = Chartist.Bar('#simpleBarChart2', dataSimpleBarChart, optionsSimpleBarChart, responsiveOptionsSimpleBarChart);

            //start animation for the Emails Subscription Chart
            md.startAnimationForBarChart(simpleBarChart);
				
				if ($('#multipleBarsChart4').length != 0) {
					...
					var multipleBarsChart = Chartist.Bar('#multipleBarsChart4', dataMultipleBarsChart, optionsMultipleBarsChart, responsiveOptionsMultipleBarsChart);
