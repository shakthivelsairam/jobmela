...
<html lang="en">
  <head>
    ...
    <title>Projects/Papers Presented Portal</title>
...
@keyframes fadeout {
  ...
  <body>
    ...
    <div class="container" style="width:95%">
      ...
      <div class="registration-form">
          ...
          try {
		    ...
		    $devCount = "select rowid,link_family_family,title,url,dateofpublished,description from projects_presented where link_family_family=?";
		  ...
		  <h3>Projects / Papers Presented</h3>
		  ...
		  <span class="removeRow" id="removeRow" name="removeRow">
			...
			<input type="text" name="pDesc" id="pDesc" class="form-control" placeholder="Description"  value="<?php echo $p[5]; ?>" />  
			</div>
		...
		<div class="form-row">
		<div class="col-xs-12 add-btn" style="border:0px solid red;float:right;width:7%">
	...
	singRow = singRow+'</div><div class="col-xs-2 small-txt-box"><label for="inputCity">Title</label><input type="text" name="pTitle" id="pTitle" class="form-control" placeholder="Title"  value="" /></div><div class="col-xs-3 small-txt-box"><label for="inputCity">URL</label>';
	singRow = singRow+'<input type="text" name="pURL" id="pURL" class="form-control" placeholder=""  value="" />  </div>';
	singRow = singRow+'<div class="col-xs-2 small-txt-box"><label for="inputCity">Date Published</label>';
